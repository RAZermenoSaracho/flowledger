...
export const transactionSchema = z.object({
  ...
  householdCategoryId: z.string().min(1).optional().nullable(),
  accountId: z.string().min(1).optional().nullable(),
  notes: z.string().trim().max(2000).optional().nullable(),
  sharedExpense: transactionSharedExpenseSchema.optional()
});

export const updateTransactionSchema = transactionSchema.omit({ sharedExpense: true }).partial();
...
export const transactionFiltersSchema = z.object({
  ...
  householdCategoryId: z.string().min(1).optional(),
...
export type TransactionSharedExpenseInput = z.infer<typeof transactionSharedExpenseSchema>;
