              ...
              return (
                ...
                >
                  {availableAmount <= 0 ? (
                    ...
                    <form
                      className="grid gap-3 md:grid-cols-2 xl:grid-cols-[minmax(0,10rem)_minmax(0,12rem)_minmax(0,12rem)_1fr_auto]"
                ...
                >
                  <EmptyState>
                    {hasPendingRequest
                      ...
                      : "Waiting for the debtor to request settlement with payment details."}
                  </EmptyState>
                </DebtCard>
              );
            })
