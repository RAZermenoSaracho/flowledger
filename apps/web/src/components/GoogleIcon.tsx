...
export function GoogleIcon({ className = "h-5 w-5" }: GoogleIconProps) {
  return (
    ...
    >
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.17 0 9.86-1.98 13.41-5.19l-6.19-5.24C29.21 35.11 26.72 36 24 36c-5.2 0-9.62-3.31-11.29-7.94l-6.52 5.03C9.5 39.56 16.22 44 24 44Z"
      />
      <path
        fill="#1976D2"
        d="M43.61 20.08H42V20H24v8h11.3a12.04 12.04 0 0 1-4.1 5.58l.01-.01 6.19 5.24C36.97 39.2 44 34 44 24c0-1.34-.14-2.63-.39-3.92Z"
      />
    </svg>
  );
}
